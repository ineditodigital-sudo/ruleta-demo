...
import { Palette, Trophy, Settings, Download, Plus, Trash2, Eye, Users, MonitorSmartphone, Sparkles, Monitor, Lock, BarChart, Gift, Edit } from 'lucide-react';
        ...
        <Tabs defaultValue="prizes" className="space-y-6">
                      ...
                      <div className="flex items-center gap-4 flex-1">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex gap-2 mt-1">
                            <Badge variant="secondary">{prize.probability}% probabilidad</Badge>
          ...
          <TabsContent value="demo" className="space-y-6">
            <Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  <Label>URL de la Imagen del Marco</Label>
                  <Input
                ...
                <div className="border-t pt-6">
                  ...
                  {/* Visual Preview */}
                  <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-8 flex justify-center items-center">
                ...
                <div className="bg-slate-100 dark:bg-slate-800 p-4 rounded-lg">
                  ...
                  <div className="text-sm space-y-1 font-mono">
                    <p><span className="text-muted-foreground">URL:</span> {state.demoConfig.frameImageUrl || 'No configurada'}</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex gap-4">
                  <Button variant="outline" onClick={resetDailyCount}>
